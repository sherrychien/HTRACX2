...
def Hid_corr (seq1,seq2,test1,test2,str1,str2):
    ...
    corr_Hid, corr_Hid1, corr_Hid2 = (np.zeros((0)) for i in range(3))
    seq1 = seq1[2:]
    seq2 = seq2[2:]
    ...
    test1_arr, test1_arr1, test1_arr2 = (np.zeros((s1)) for i in range(3))
    test2_arr, test2_arr1, test2_arr2 = (np.zeros((s2)) for i in range(3))
...
for i in range(0,n_sbj):
    ...
    #Test model trained with structured sequences
    ...
    #Test model trained with shuffled sequences
    ...
    #Calculate the correlation of the representation generated by intact sequence and sequences scrambled by differetn scales
    ...
    #store the delta for further analysis
    ...
    #store the hidden representation for further analysis
