...
def TRACX(t, delta_lower, delta_self, Hid_lower, Hid_self, RHS_lower, RHS_self, IH_wts, HO_wts, learning_rate, tau, learning, objective_func, k, ip_noise):
    bias_node = np.array([-1])
    ...
    if t == 0:
        t1 = (1-b)*Hid_lower + b*RHS_lower + input_noise
    else:
        ctx=tau/(tau+a)
        inp=a/(tau+a)
...
def HTRACX_learn(bipolar_seq, IH_wts, HO_wts, IH_wts1, HO_wts1, IH_wts2, HO_wts2, learning_rate_initial, tau_array, Modeltype, objective_func, k, ip_noise):
    ...
    while t+1 < s[0]:
        ...
        if Modeltype == 'Hid_only':
            ...
            delta_lower=delta
        H1 = TRACX(t, delta_lower, delta1, Hid, Hid1, RHS0, RHS1, IH_wts1, HO_wts1, learning_rate1, tau1, True, objective_func, k2, ip_noise)
        Hid1 = H1['Hid']
        RHS1 = H1['RHS']
        IH_wts1 = H1['IH_wts']
        HO_wts1 = H1['HO_wts']
        ...
        if Modeltype == 'Hid_only':
            ...
            delta_lower=delta1
        H2 = TRACX(t, delta_lower, delta2, Hid1, Hid2, RHS1, RHS2, IH_wts2, HO_wts2, learning_rate2, tau2, True, objective_func, k3, ip_noise)
        Hid2 = H2['Hid']
        RHS2 = H2['RHS'] 
        IH_wts2 = H2['IH_wts']
        HO_wts2 = H2['HO_wts']
    ...
    return {'IH_wts':IH_wts, 'HO_wts':HO_wts , 'IH_wts1':IH_wts1, 'HO_wts1':HO_wts1, 'IH_wts2':IH_wts2, 'HO_wts2':HO_wts2, 'D':D, 'D1':D1, 'D2':D2, 'Hid':Hid_array, 'Hid1':Hid1_array, 'Hid2':Hid2_array} 


def HTRACX_test(seq, IH_wts, HO_wts, IH_wts1, HO_wts1, IH_wts2, HO_wts2, tau_array, Modeltype, objective_func, k, ip_noise):
    bipolar_seq = seq
    s = np.shape(bipolar_seq)
    arr_size = np.shape(bipolar_seq[0])
    ...
    while t+1 < s[0]:
        ...
        if Modeltype == 'Hid_only':
            ...
            delta_lower=delta
        H1 = TRACX(t, delta_lower, delta1, Hid, Hid1, RHS0, RHS1, IH_wts1, HO_wts1, 0, tau1, False, objective_func, k2, ip_noise)
        Hid1 = H1['Hid']
        RHS1 = H1['RHS'] 
        delta1 = H1['Delta']
        ...
        H2 = TRACX(t, delta_lower, delta2, Hid1, Hid2, RHS1, RHS2, IH_wts2, HO_wts2, 0, tau2, False, objective_func, k3, ip_noise)
        Hid2 = H2['Hid']
        RHS2 = H2['RHS'] 
        delta2 = H2['Delta']
