...
def HAT_learn(bipolar_seq, IH_wts, HO_wts, IH_wts1, HO_wts1, IH_wts2, HO_wts2, learning_rate_initial, tau_array, Modeltype, objective_func, k, ip_noise):
    ...
    while t+1 < s[0]:
        ...
        if Modeltype == 'Hid_only':
            ...
            delta_lower=delta
        H1 = AT_module(t, delta_lower, delta1, Hid, Hid1, RHS0, RHS1, IH_wts1, HO_wts1, learning_rate1, tau1, True, objective_func, k2, ip_noise)
        Hid1 = H1['Hid']
        RHS1 = H1['RHS']
        IH_wts1 = H1['IH_wts']
        HO_wts1 = H1['HO_wts']
        ...
        if Modeltype == 'Hid_only':
            ...
            delta_lower=delta1
        H2 = AT_module(t, delta_lower, delta2, Hid1, Hid2, RHS1, RHS2, IH_wts2, HO_wts2, learning_rate2, tau2, True, objective_func, k3, ip_noise)
        Hid2 = H2['Hid']
        RHS2 = H2['RHS'] 
        IH_wts2 = H2['IH_wts']
        HO_wts2 = H2['HO_wts']
...
def HAT_test(seq, IH_wts, HO_wts, IH_wts1, HO_wts1, IH_wts2, HO_wts2, tau_array, Modeltype, objective_func, k, ip_noise):
    ...
    while t+1 < s[0]:
        ...
        if Modeltype == 'Hid_only':
            ...
            delta_lower=delta
        H1 = AT_module(t, delta_lower, delta1, Hid, Hid1, RHS0, RHS1, IH_wts1, HO_wts1, 0, tau1, False, objective_func, k2, ip_noise)
        Hid1 = H1['Hid']
        RHS1 = H1['RHS'] 
        delta1 = H1['Delta']
        ...
        H2 = AT_module(t, delta_lower, delta2, Hid1, Hid2, RHS1, RHS2, IH_wts2, HO_wts2, 0, tau2, False, objective_func, k3, ip_noise)
        Hid2 = H2['Hid']
        RHS2 = H2['RHS'] 
        delta2 = H2['Delta']
